...
export type ConsentThemeV1 = Schemas['ConsentThemeV1']
export type ConsentThemeV2 = Schemas['ConsentThemeV2']
export type ConsentReopenPlacement = Schemas['ConsentReopenPlacement']
export type ConsentTrackerConfig = Schemas['ConsentTrackerConfig']
